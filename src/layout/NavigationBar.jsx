...
//   return (
//     <>
//       <div className="mx-auto px-2 rounded-xl border border-transparent bg-white/10 shadow-[0_0_0_2px_rgba(255,255,255,0.6),0_16px_32px_rgba(0,0,0,0.12)] backdrop-blur-[20px] flex items-center justify-center min-h-[4.5rem] w-[70%]">
  ...
  return (
    <>
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="frosted rounded-xl border border-transparent bg-white shadow-[0_0_0_2px_rgba(255,255,255,0.6),0_16px_32px_rgba(0,0,0,0.12)] flex items-center justify-between py-1 px-4 sm:px-6 md:px-8">
          {/* Logo */}
          <img
            src={logo}
            alt="logo"
          ...
          {/* Sliding Tabs (Desktop Only) */}
          {!isMobileMode && (
            <div className="relative flex flex-wrap items-center gap-2 sm:gap-3 md:gap-5">
              <div
                className="absolute top-0 left-0 h-full border border-white/50 bg-white/20 backdrop-blur-xl rounded-3xl z-0 transition-all duration-300 ease-in-out"
                style={{
                  width: activeWidth,
              ...
              {Menu_Items.map((item, index) => (
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `relative z-10 px-3 py-1.5 sm:px-4 sm:py-2 text-[16px] sm:text-[17px] md:text-[18px] font-medium rounded-md transition-colors duration-300 ease-in-out ${
          ...
          {!isMobileMode && (
            <LogOut
              className="w-10 h-10 text-[#0e9dc7] cursor-pointer"
              onClick={handleLogout}
            />
          )}
            ...
            >
              ...
              <div className="flex items-center justify-between px-4 py-4 sm:px-6 md:px-10 md:py-6">
                ...
                <button
                  ...
                  onClick={() => setIsMenuOpen(false)}
                >
                  <X className="h-8 w-8 sm:h-9 sm:w-9 md:h-10 md:w-10 text-white" />
                </button>
              </div>

...
//       <div className="relative overflow-hidden shadow-lg sm:rounded-xl h-full w-full bg-white p-4">
//         {/* Header */}
//         <div className="flex flex-row justify-between items-center gap-3">
//           <div className="flex gap-4 justify-start">
//             <button onClick={() => navigate(-1)}>
//               <MoveLeft className="w-5 h-7 text-gray-700" />
//             </button>
...
//               <button className="flex items-center justify-center p-2 bg-white border border-gray-300 rounded hover:bg-gray-100 hover:shadow-md transition duration-300 ease-in-out mr-1">
//                 <Save />
//               </button>
//               <button className="flex items-center justify-center p-2 bg-white border border-gray-300 rounded hover:bg-gray-100 hover:shadow-md transition duration-300 ease-in-out mr-1">
//                 <Table2 />
...
//         {/* Table */}
//         <div className="pt-3">
//           <div className="overflow-auto max-h-[70vh] border border-gray-400 rounded">
...
//           .map((item) => ({
//             ...item,
//             description: item.description || "N/A", // Hidden in UI but for export
//           }))
//           .sort((a, b) => a.part_no.localeCompare(b.part_no));
//         setTableData(sortedData);

//         const savedPercentage = localStorage.getItem(`profit_${assembly}`);
//         if (savedPercentage) setProfitPercentage(Number(savedPercentage));
//       } else {
//         setError("No data found");
//       }
//     } catch (err) {
...
//       if (!newData[rowIndex][nf]) newData[rowIndex][nf] = 0;
//     });

//     const unit = numericFields.reduce(
//       (acc, nf) => acc + Number(newData[rowIndex][nf]),
//       0
//     );
...
//       }));
//       await axios.post("http://127.0.0.1:8000/uploader/update_cost/", payload);
...
//     });
//     saveAs(blob, `${assembly}_review.xlsx`);
//   };
...
//     );
//     const doc = new jsPDF();
//     doc.text(`Review Table - ${assembly}`, 14, 15);
//     const tableColumn = [
//       "Part No.",
//       "Description",
//       "Material",
...
//               <button
//                 onClick={handleSave}
//                 className="flex items-center justify-center p-2 bg-white border border-gray-300 rounded hover:bg-gray-100 hover:shadow-md transition duration-300 ease-in-out mr-1"
//               >
//                 <Save />
//               </button>
//               <button
//                 onClick={exportToExcel}
//                 className="flex items-center justify-center p-2 bg-white border border-gray-300 rounded hover:bg-green-50 hover:shadow-md transition duration-300 ease-in-out mr-1"
//               >
//                 <Table2 />
//               </button>
//               <button
//                 onClick={exportToPDF}
//                 className="flex items-center justify-center p-2 bg-white border border-gray-300 rounded hover:bg-blue-50 hover:shadow-md transition duration-300 ease-in-out mr-1"
//               >
//                 <FileText />
//               </button>
//             </div>
...
//           <label>Profit Percentage: {profitPercentage}%</label>
//           <input
//             type="range"
//             min="0"
//             max="100"
...
//                           ) : (
//                             <input
//                               type={field === "part_no" ? "text" : "number"}
//                               value={item[field] ?? ""}
//                               onChange={(e) =>
//                                 handleCellChange(
//                                   idx,
...
//         `http://127.0.0.1:8000/uploader/get_metadata/?projectName=${assembly}`
//       );
...
//         setTableData(sortedData);
//         setGrandTotal(
//           sortedData.reduce((sum, row) => sum + (row.total || 0), 0)
//         );
...
//       await axios.post("http://127.0.0.1:8000/uploader/update_dashboard/", {
...
//     saveAs(blob, `${quotationName}.xlsx`);
//   };
...
//               <button
//                 onClick={exportToExcel}
//                 className="p-2 bg-white border rounded hover:bg-green-50"
//               >
//                 <Table2 />
//               </button>
//               <button
//                 onClick={exportToPDF}
//                 className="p-2 bg-white border rounded hover:bg-blue-50"
//               >
//                 <FileText />
//               </button>
//             </div>
...
//         {/* Table */}
//         <div className="pt-3">
//           <div className="overflow-auto max-h-[68vh] border border-gray-400 rounded">
//             <table className="w-full text-sm text-left text-gray-800 border-collapse">
//               <thead className="bg-gray-100 uppercase text-xs sticky top-0 z-10">
//                 <tr>
//                   {costFields.map((field) => (

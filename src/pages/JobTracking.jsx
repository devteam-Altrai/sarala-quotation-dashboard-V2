              ...
              project.map((assembly, index) => (
                ...
                >
                  ...
                  <div className="flex flex-row justify-center items-center w-fit px-2 gap-4">
                    ...
                    >
                      <div className="absolute top-1/2 right-1 -translate-y-1/2 h-[82%] bg-white flex justify-center items-center rounded-md p-1 w-10 group-hover:w-[94.6%] transition-all">
                        <FileSpreadsheet
